...
@SuppressLint("NewApi") @TargetApi(Build.VERSION_CODES.HONEYCOMB) public abstract class SwitchLayout {
	...
	@TargetApi(Build.VERSION_CODES.HONEYCOMB) @SuppressLint("NewApi") public static void FlipUpDown(Activity context, boolean isCloseActivity,
			Interpolator interpolator) {
		activity = context;
	...
	@SuppressLint("NewApi") public static void FlipUpDown(View view, boolean isCloseActivity,
			Interpolator interpolator) {
